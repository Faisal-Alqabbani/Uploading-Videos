...
class CommentController extends Controller
{
    ...
    public function saveComment(Request $request){
        ...
        return response()->json(['userName' => $userName, 'commentDate' => $commentDate, 'commentId' => $commentId, 'userImage' => $userImage]);
    ...
    public function update(Request $request, $id){
        ...
        $comment->save();
        return redirect('videos/'.$videoId)->with('success', 'تم تعديل التعليق بنجاح');
