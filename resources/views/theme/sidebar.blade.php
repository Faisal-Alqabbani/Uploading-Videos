  ...
  <ul class="pr-0 navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    {{-- {{ request()->is('admin/channels') ? 'active' : '' }} --}}
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    {{-- {{ request()->is('admin/channels/blocked*') ? 'active' : '' }} --}}
    <li class="nav-item {{ request()->is('admin/channels/blocked*') ? 'active' : '' }}">
        {{-- {{ route('channels.blocked') }} --}}
    ...
    <!-- Nav Item - Charts -->
    {{-- {{ request()->is('admin/MostViewedVideos*') ? 'active' : '' }} --}}
    <li class="nav-item">
        {{-- {{ route('most.viewed.video') }} --}}
